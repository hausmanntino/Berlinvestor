    ...
    for ticker in SeriestickerList:
        try:
            ...
            if len(ST['stockPrice']) >= 5 :
                ...
                if RevCAGR >= 20 and RevYoY > 0 and DeltaEBITDAexRevCAGR >= 10 and EBITDAexYoY > 0 and PL['ebitda'].iloc[0] < 0 and PL['ebitda'].iloc[1] < 0 and PL['ebitda'].iloc[4] < 0:
                    GV6list.append(ticker)
        except:
            continue
